...
const strings = {
  ...
  "dash.helpRewriteMode": { zh: "重写：基于当前设定，允许重组问题段落、调整画面和叙述力度，但优先保留原文的绝大部分句段", en: "Rewrite: Based on current settings, allow restructuring problematic paragraphs, adjusting scenes and narrative intensity, but prioritize preserving most of the original text" },
  "dash.helpRework": { zh: "重作：基于当前设定，可大幅重构场景推进和冲突组织，让章节适应新大纲，但保持当前主设定和大事件结果不变", en: "Rework: Based on current settings, can significantly restructure scene progression and conflict organization to adapt chapters to new outline, while keeping current main settings and major event outcomes unchanged" },
